...
@endif
      <div class="bg-[#f8f9ff]  text-[#333] text-[15px]">
        <div class="relative">
          <div class="px-4 sm:px-10">
            <div class="mt-16 max-w-4xl mx-auto text-center relative z-10">
              ...
              <div class="mt-10">
                <button class='px-6 py-3 rounded-xl text-white bg-red-900 transition-all'>Get started
                  today</button>
              </div>
            </div>
        ...
        <div class="px-4 sm:px-10">
          <div class="mt-32 max-w-7xl mx-auto">
            ...
            <div class="grid lg:grid-cols-3 md:grid-cols-2 max-md:max-w-lg mx-auto gap-8">
              ...
              <div class="sm:p-6 p-4 flex bg-white rounded-md border">
                ...
                <div>
                  <h3 class="text-xl font-extrabold mb-2">Security</h3>
              ...
              <div class="sm:p-6 p-4 flex bg-white rounded-md border">
                ...
                <div>
                  <h3 class="text-xl font-extrabold mb-2">Support</h3>
              ...
              <div class="sm:p-6 p-4 flex bg-white rounded-md border">
                ...
                <div>
                  <h3 class="text-xl font-extrabold mb-2">Performance</h3>
              ...
              <div class="sm:p-6 p-4 flex bg-white rounded-md border shadow-[0_14px_40px_-11px_rgba(93,96,127,0.2)]">
                ...
                <div>
                  <h3 class="text-xl font-extrabold mb-2">Global Reach</h3>
              ...
              <div class="sm:p-6 p-4 flex bg-white rounded-md border">
                ...
                <div>
                  <h3 class="text-xl font-extrabold mb-2">Communication</h3>
            ...
            <div class="grid md:grid-cols-3 md:py-16 gap-8 max-w-7xl max-md:max-w-lg mx-auto relative">
              ...
              <div class="h-auto lg:p-6 p-4 rounded-md mx-auto bg-white relative max-md:shadow-md">
                <div>
                  ...
                  <h4 class="whitespace-nowrap font-extrabold mt-2">John Doe</h4>
              ...
              <div class="h-auto lg:p-6 p-4 rounded-md mx-auto bg-white relative max-md:shadow-md">
                <div>
                  ...
                  <h4 class="whitespace-nowrap font-extrabold mt-2">Mark Adair</h4>
              ...
              <div class="h-auto lg:p-6 p-4 rounded-md mx-auto bg-white relative max-md:shadow-md">
                <div>
                  ...
                  <h4 class="whitespace-nowrap font-extrabold mt-2">Simon Konecki</h4>
          ...
          <div class="mt-32 max-w-7xl mx-auto">
            ...
            <div class="grid lg:grid-cols-3 md:grid-cols-2 gap-8 mt-16 max-md:max-w-lg max-md:mx-auto">
              <div class="bg-white rounded sm:p-6 p-4">
                <h3 class="text-xl font-extrabold">Free</h3>
                <p class="mt-2">Ideal for individuals who need quick access to basic features.</p>
                <div class="mt-6">
                  <h2 class="text-4xl font-bold">$0<span class="text-gray-500 ml-2 text-[15px]">/ Month</span></h2>
                  <button type="button"
              ...
              <div class="bg-blue-600 rounded sm:p-6 p-4 text-white shadow-lg shadow-blue-300">
                <h3 class="text-xl font-extrabold">Professional</h3>
                <p class="mt-2">Ideal for individuals who who need advanced features and tools for client work.</p>
                <div class="mt-6">
                  <h2 class="text-4xl font-bold">$25<span class="text-gray-200 ml-2 text-[15px]">/ Month</span></h2>
                  <button type="button"
                    class="w-full mt-6 px-6 py-3 rounded-xl text-[#333] bg-white transition-all hover:bg-gray-100">Get
                    Started</button>
                </div>
                <div class="mt-6">
                  <h4 class="text-base font-bold mb-4">Plan Includes</h4>
              ...
              <div class="bg-white rounded sm:p-6 p-4">
                ...
                <div class="mt-6">
                  <h2 class="text-4xl font-bold">$100<span class="text-gray-500 ml-2 text-[15px]">/ Month</span></h2>
                  <button type="button"
                    class="w-full mt-6 px-6 py-3 rounded-xl text-white bg-cyan-900 transition-all hover:bg-cyan-800">Get
                    Started</button>
                </div>
          ...
          <div class="bg-white mt-32 px-4 py-12">
            <div class="grid sm:grid-cols-2 items-center gap-16 my-6 mx-auto max-w-5xl">
              <div>
                ...
                <div class="mt-12">
                  <h2 class="text-xl font-extrabold">Socials</h2>
          ...
          <div class="bg-blue-100 py-20 sm:px-6 px-4 rounded-3xl mt-32">
        ...
        <footer class="bg-cyan-900 px-4 sm:px-10 py-12 mt-32">
          <div class="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-4 gap-8">
            <div>
              <h4 class="text-white font-extrabold text-xl mb-6">Quick Links</h4>
              <ul class="space-y-4">
                <li>
                  <a href="javascript:void(0)" class="hover:text-white text-gray-300 transition-all">Our Story</a>
                </li>
                <li>
                  <a href="javascript:void(0)" class="hover:text-white text-gray-300 transition-all">Newsroom</a>
                </li>
                <li>
                  <a href="javascript:void(0)" class="hover:text-white text-gray-300 transition-all">Careers</a>
                </li>
                <li>
                  <a href="javascript:void(0)" class="hover:text-white text-gray-300 transition-all">Blog</a>
                </li>
              </ul>
            </div>
            <div>
              <h4 class="text-white font-extrabold text-xl mb-6">Services</h4>
              <ul class="space-y-4">
                <li>
                  <a href="javascript:void(0)" class="hover:text-white text-gray-300 transition-all">Web Development</a>
                </li>
                <li>
                  <a href="javascript:void(0)" class="hover:text-white text-gray-300 transition-all">Testing Automation</a>
                </li>
                <li>
                  <a href="javascript:void(0)" class="hover:text-white text-gray-300 transition-all">AWS Development
                    Services</a>
                </li>
                <li>
                  <a href="javascript:void(0)" class="hover:text-white text-gray-300 transition-all">Mobile App
                    Development</a>
                </li>
              </ul>
            </div>
            <div>
              <h4 class="text-white font-extrabold text-xl mb-6">Platforms</h4>
              <ul class="space-y-4">
                <li>
                  <a href="javascript:void(0)" class="hover:text-white text-gray-300 transition-all">Hubspot</a>
                </li>
                <li>
                  <a href="javascript:void(0)" class="hover:text-white text-gray-300 transition-all">Marketo Integration
                    Services</a>
                </li>
                <li>
                  <a href="javascript:void(0)" class="hover:text-white text-gray-300 transition-all">Marketing Glossary</a>
                </li>
                <li>
                  <a href="javascript:void(0)" class="hover:text-white text-gray-300 transition-all">UIPath</a>
                </li>
              </ul>
            </div>
            <div>
              <h4 class="text-white font-extrabold text-xl mb-6">Company</h4>
              <ul class="space-y-4">
                <li>
                  <a href="javascript:void(0)" class="hover:text-white text-gray-300 transition-all">Accessibility</a>
                </li>
                <li>
                  <a href="javascript:void(0)" class="hover:text-white text-gray-300 transition-all">About</a>
                </li>
                <li>
                  <a href="javascript:void(0)" class="hover:text-white text-gray-300 transition-all">Contact</a>
                </li>
                <li>
                  <a href="javascript:void(0)" class="hover:text-white text-gray-300 transition-all">Learn more</a>
                </li>
              </ul>
            </div>
          </div>
          <div class="border-t text-center border-gray-400 pt-8 mt-8">
