                        ...
                        <tr>
                            ...
                            <td>
                                <form method="POST" action="{{ route('admin.toggleAccess', $user->id) }}">
                                    @method('PATCH')
                                    @csrf
                                    <button type="submit" class="px-2 inline-flex text-xs leading-5 font-semibold rounded-full bg-green-100 text-green-800">{{ $user->access ? 'Disable Access' : 'Enable Access' }}</button>
                                </form>
                            </td>
