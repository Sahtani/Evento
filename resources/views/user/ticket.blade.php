...
<div class="min-h-screen bg-gray-100 flex items-center justify-center">
    <div class="px-10">
      <div class="bg-white max-w-xl rounded-2xl px-10 py-8 shadow-lg hover:shadow-2xl transition duration-500">
        ...
        <div class="mt-4">
          <h1 class="text-lg text-gray-700 font-semibold hover:underline cursor-pointer">{{ $reservation->event->title }}</h1>
          <div class="flex mt-2">
          ...
          <p class="mt-4 text-md text-gray-600">Date: {{ $reservation->event->created_at }}</p>
