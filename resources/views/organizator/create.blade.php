...
@section('form')
    <div class="mt-6 ">
        <div
            ...
            <a href="{{ route('organizator.organdashboard') }}" title="Back to home your events">
            ...
            <form class="ml-auo space-y-4" method="POST" action="{{ route('organizator.storevent') }}" enctype="multipart/form-data">
                @csrf
                ...
                <div class="mt-4">
                    ...
                    <div class="flex justify-between mt-3">
                        ...
                        <div class="flex items-center ps-4 px-4 ">  
                            <input id="bordered-radio-1" type="radio" value="automatic" name="mode"
                                class="w-4 h-4 text-red-800 bg-gray-100 border-gray-300 focus:ring-red-800  focus:ring-2">
                            <label for="bordered-radio-1"
                                class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Automatic Acceptance</label>
                        </div>
                        <div class="flex items-center ps-4">
                            <input checked id="bordered-radio-2" type="radio" value="manual" name="mode"
                                class="w-4 h-4 text-red-800 bg-gray-100 border-gray-300 focus:ring-red-800  focus:ring-2 ">
                            <label for="bordered-radio-2"
                                class="w-full py-4 ms-2 text-sm font-medium text-gray-900 dark:text-gray-300">Manual Approval</label>
                        </div>
